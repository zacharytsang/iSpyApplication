...
namespace iSpyApplication
{
    public partial class AddFloorPlan : Form
    {
        ...
        private void AddFloorPlanLoad(object sender, EventArgs e)
        {
            ...
            _pnlPlan = new PictureBox {Location = new Point(64, 67), Size = new Size(533, 400), AllowDrop = true};
            Controls.Add(_pnlPlan);
        ...
        private void RenderResources()
        {
            ...
            lblResized.Text = LocRm.GetString("FloorplanResized");
        ...
        private void BtnChooseFileClick(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog(this) == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    Fpc.ImgPlan = rf.Apply((Bitmap) img);
                    _floorPlanImage = (Bitmap) Fpc.ImgPlan.Clone();
                }
                catch (Exception ex)
                {
        ...
        {
            Help.ShowHelp(this, MainForm.Website+"/userguide-floorplans.aspx");
        }
