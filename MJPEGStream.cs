        ...
        private void WorkerThread( )
		{
			...
			while ( true )
			{
				...
				try
				{
                    ...
                    //Commented this code as this class now accepts application/octet-stream from VLC as well as multipart/mixed
                    //
                    ...
                    while ((!stopEvent.WaitOne(0, true)) && (!reloadEvent.WaitOne(0, true)))
					{
                        ...
                        if ( !boundaryIsChecked && hasBoundary)
                        {
                            ...
                            // continue reading if boundary was not found
                            if ( pos == -1 )
                                continue;
                            ...
                            for ( int i = pos - 1; i >= 0; i-- )
                            {
                                ...
                                boundaryStr = (char) ch + boundaryStr;
                            }
						...
						while ( ( align == 2 ) && ( todo >= boundaryLen ) )
						{
                            ...
                            if (hasBoundary)
                                ...
                                stop = ByteArrayUtils.Find( buffer, jpegMagic, pos+3, todo);
							if ( stop != -1 )
							{
								pos		= stop;
								todo	= total - pos;
								...
								{
                                    MemoryStream _ms = new MemoryStream(buffer, start, (stop - start));
                                    Bitmap bmp = (Bitmap)Bitmap.FromStream(_ms, false, false);
